    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{__('invoices.print invoice')}}</span>
            </div>
        </div>
                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2"> {{ is_numeric($invoices->discount) ? number_format($invoices->discount, 2):$invoices->discount }}</td>
